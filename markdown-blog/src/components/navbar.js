...
const Navbar = () => {
    return (
        <div className='font-serif lg:text-lg md:text-lg text-md flex flex-row p-2 bg-gray-900 text-gray-50 h-fit items-center lg:items-end md:justify-items-end'>
